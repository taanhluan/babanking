...
const paymentTypeAliases = ['internal-transfer', 'same-owner-transfer', 'domestic-interbank-transfer', 'international-transfer', 'bill-payment', 'qr-payment', 'card-payment', 'top-up', 'payroll', 'bulk-payment', 'supplier-payment', 'tax-payment', 'collection', 'direct-debit', 'virtual-account', 'merchant-collection', 'scheduled-payment', 'standing-order'];
