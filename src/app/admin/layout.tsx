...
export default async function Layout({ children }: { children: React.ReactNode }) { const user = await requireRole('ADMIN'); return <WorkspaceShell user={user}>{children}</WorkspaceShell>; }
